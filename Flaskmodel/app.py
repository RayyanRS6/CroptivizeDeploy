...
# Import the correct model architecture (direct ResNet9)
...
# Define your class labels with the exact names from your training data (COTTON ONLY)
...
try:
    ...
    model = ResNet9(in_channels=3, num_diseases=num_classes)  # Instantiate ResNet9 directly
